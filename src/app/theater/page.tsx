...
import { dormitoryPost, theaterPost } from "@/redux/thunkFunctions/psotThunk";
...
export default function Theater() {
  ...
  useEffect(() => {
    dispatch(theaterPost()); //thucnk 함수 이름은 authUser
  ...
  return (
    <section>
      <div className=" text-xl font-bold flex  justify-between items-center">
        <Link href={"/"}>{"<"}</Link>
        <h1 className="text-xl font-bold">노천극장 게시판 </h1>
