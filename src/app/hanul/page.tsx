...
import { hanulPost } from "@/redux/thunkFunctions/psotThunk";

export default function Hanul() {
  ...
  useEffect(() => {
    dispatch(hanulPost()); //thucnk 함수 이름은 authUser
  ...
  return (
    <section>
      <div className=" text-xl font-bold flex  justify-between items-center">
        <Link href={"/"}>{"<"}</Link>
        <h1 className="text-xl font-bold">한울관 게시판 </h1>
